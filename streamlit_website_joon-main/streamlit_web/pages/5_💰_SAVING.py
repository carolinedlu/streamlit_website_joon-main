...
expenses = ["🏠_Rent","Utilities","Groceries","Car" , "Other Expenses", "Saving"]
...
# 제일 처음에 위치 해야함
st.set_page_config(page_title=page_title , page_icon=page_icone, layout=layout)
...
if selected =="Data Visualization":
    ...
    with st.form("saved_periods"):
        ...
        if submitted :
            ...
            expenses ={"🏠_Rent":600, "Utilities":200, "Groceries":300, "Car":100 , "Other Expenses":50, "Saving" :10}
